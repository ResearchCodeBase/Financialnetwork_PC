...
class ProportionalNodeSplit(BaseTransform):
...
def _split(self, store: NodeStorage) -> Tuple[Tensor, Tensor, Tensor]:
    ...
    for c in range(num_classes):
        ...
        # 计算每个集合的样本数
        num_train = round(num_samples * self.num_train_per_class)
        ...
        test_mask[idx[num_train + num_val:num_train + num_val + num_test]] = True
